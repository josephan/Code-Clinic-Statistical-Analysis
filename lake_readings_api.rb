...
get '/' do
	...
	text << "<p>Calculates the mean and median of the wind seed, air 
	temperature, and barometric pressure recorded at the Deep Moor station 
	on Lake Pend Oreille for a given range of dates.</p>"
